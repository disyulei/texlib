...
\usepackage{perpage}                           % reset footnote index every page
\MakePerPage{footnote}                         %
\renewcommand{\thefootnote}{\arabic{footnote}} % footnote index in Arabic numerals
\renewcommand{\footnotesize}{\scriptsize}
\newcommand\blfootnote[1]{                     % define blfootnote function
    \begingroup
...
\newenvironment<>{qblock}[2][\textwidth]{%
  ...
  \setbeamercolor{block body}{fg=black,bg=yellow!6}
  \begin{actionenv}#3%
  \def\insertblocktitle{#2}%
  \par%
  \usebeamertemplate{block begin}}
